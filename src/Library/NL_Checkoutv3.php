...
namespace QsoftVN\NganLuong\Library;
...
class NL_CheckOutV3
{
    ...
    public function __GetTransactionDetail($token)
    {
        ###################### BEGIN #####################
        $params = array(
     ...
     */
    public function __VisaCheckout($order_code, $total_amount, $payment_type, $order_description, $tax_amount,
